...
//        System.out.println("복호화할 바이트 종료");
        ...
        for(int i=0; i<encByteList.size(); i++){
            ...
            encryptSEED.SeedDecrypt(encByte, seedKey, tempDecByte);
    ...
    public static String decrypt(String encVal, String seedkey) throws Exception {
    	return getSeedDecrypt(encVal, getSeedRoundKey(seedkey));
    	
    }
   
    public static String encrypt(String decVal, String seedkey) throws Exception {
    	return getSeedEncrypt(decVal, getSeedRoundKey(seedkey));
...
//        System.out.println("암호화된 바이트 시작");
        ...
        for(int i=0; i<byteList.size(); i++){
            ...
            encryptSEED.SeedEncrypt(byteVal, seedKey, tempEncVal);
...
//        System.out.println("암호화된 바이트 종료");
    ...
    public static int[] getSeedRoundKey(String keyStr) throws Exception{
        ...
        encryptSEED.SeedRoundKey(seedKey, keyStr.getBytes());
